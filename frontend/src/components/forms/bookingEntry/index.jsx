...
export default function BookingEntry() {
  ...
  const handleSave = async () => {
    ...
    if (
      (billingDetails.bookingType == 'topay' ||
        billingDetails.bookingType == 'cash') &&
      (parseInt(billingDetails.amountToPay) <= 0 ||
        billingDetails.amountToPay == '')
    ) {
      message.warning('Please enter topay/cash amount greater than 0');
      return;
    }
    if (
      billingDetails.codType == 'cod' &&
      (parseInt(billingDetails.codAmount) <= 0 ||
        billingDetails.codAmount == '')
    ) {
    ...
    if (
      parseInt(volWeight.totalActualWeight) <= 0 ||
      volWeight.totalActualWeight == ''
    ) {
  ...
  useEffect(()=>{
    if(err || err1){
        message.error("Network Error: Failed to fecth resources from the server")
    }
  },[err,err1])
      ...
      <div className={style.formContainer}>
        ...
        <div>
          ...
          <input
            ...
            value={awbDetails.docketNumber}
            onInput={(e) => handleAwbDetails(e, 'docketNumber')}
          />
          <label htmlFor="">
            Origin <Mandatory />
          </label>
          <input
            type="text"
            value={awbDetails.originText}
            list="dests"
            placeholder="Origin"
            onInput={(e) => handleAwbDetails(e, 'origin')}
          />
          <datalist id="dests">
            {dests.map((b) => (
          ...
          <select
            value={awbDetails.mode}
            onInput={(e) => handleAwbDetails(e, 'mode')}
          >
          ...
          <input
            type="text"
            list="dests"
            value={awbDetails.destinationText}
            placeholder="Destination"
            onInput={(e) => handleAwbDetails(e, 'destination')}
          />

          <label htmlFor="">Customer type</label>
          <select
            value={awbDetails.customerType}
            onInput={(e) => handleAwbDetails(e, 'customerType')}
          >
          ...
          <span>
            <input
              ...
              onClick={(e) => {
                e.target.checked
                  ? handleAwbDetails({ target: { value: true } }, 'isOda')
                  : handleAwbDetails({ target: { value: false } }, 'isOda');
              }}
            />
            {awbDetails?.isOda ? (
              <input
      ...
      <div className={style.formContainer}>
        ...
        <div>
          ...
          <input
            ...
            onInput={(e) => handleBillingDetails(e, 'clientName')}
          />
          <datalist id="clients">
            {clients.map((d) => (
          ...
          <input
            ...
            onInput={(e) => handleBillingDetails(e, 'invoiceNumber')}
          />
          <label htmlFor="">Invoice Value</label>
          <input
            type="text"
            placeholder="0.00"
            value={billingDetails.invoiceValue}
            onInput={(e) => handleBillingDetails(e, 'invoiceValue')}
          />

          <label htmlFor="">
            Billing At <Mandatory />
          </label>
          ...
          <select
            value={billingDetails.billingAt}
            onChange={(e) => handleBillingDetails(e, 'billingAt')}
          >
          ...
          <input
            ...
            value={billingDetails.ewayBillNo}
            onInput={(e) => handleBillingDetails(e, 'ewayBillNo')}
          />
          <label htmlFor="">Item Content</label>
          <select
            value={billingDetails.itemContent}
            onInput={(e) => handleBillingDetails(e, 'itemContent')}
          >
          ...
          <select
            value={billingDetails.bookingType}
            onInput={(e) => handleBillingDetails(e, 'bookingType')}
          >
          ...
          <label htmlFor="">
            To Pay/Cash Amt. <Mandatory />
          </label>
          <input
            type="text"
            disabled={
              billingDetails.bookingType == 'credit' ||
              billingDetails.bookingType == 'null'
            }
            placeholder="To Pay/Cash Amount"
            value={billingDetails.amountToPay}
            onInput={(e) => handleBillingDetails(e, 'amountToPay')}
          />
          <label htmlFor="">ODA Charges</label>
          <input
            type="text"
            placeholder="0.00"
            value={billingDetails.odaCharges}
            onInput={(e) => handleBillingDetails(e, 'odaCharges')}
          />

          <label htmlFor="">COD Type</label>
          <select
            value={billingDetails.codType}
            onInput={(e) => handleBillingDetails(e, 'codType')}
          >
          ...
          <label htmlFor="">
            COD Amount <Mandatory />
          </label>
          <input
            type="text"
            placeholder="COD Amount"
            disabled={
              billingDetails.codType == 'null' ||
              billingDetails.codType == 'noncod'
            }
            value={billingDetails.codAmount}
            onInput={(e) => handleBillingDetails(e, 'codAmount')}
          />
        </div>
      </div>
      ...
      <div className={style.formContainer}>
        ...
        <div>
          ...
          <input
            ...
            value={consignorConsignee.consignor}
            onInput={(e) => handleConsignorConsignee(e, 'consignor')}
          />
          <label htmlFor="">Consignor Contact</label>
          <input
            type="text"
            placeholder="Consignor Contact No"
            value={consignorConsignee.consignorContact}
            onInput={(e) => handleConsignorConsignee(e, 'consignorContact')}
          />
          <label htmlFor="">Consignor Address</label>
          <input
            type="text"
            placeholder="Consignor Address"
            value={consignorConsignee.consignorAddress}
            onInput={(e) => handleConsignorConsignee(e, 'consignorAddress')}
          />
          ...
          <input
            ...
            value={consignorConsignee.consignee}
            onInput={(e) => handleConsignorConsignee(e, 'consignee')}
          />
          <label htmlFor="">Consignee Contact</label>
          <input
            type="text"
            placeholder="Consignee Contact No"
            value={consignorConsignee.consigneeContact}
            onInput={(e) => handleConsignorConsignee(e, 'consigneeContact')}
          />
          <label htmlFor="">Consignee Address</label>
          <input
            type="text"
            placeholder="Consignee Address"
            value={consignorConsignee.consigneeAddress}
            onInput={(e) => handleConsignorConsignee(e, 'consigneeAddress')}
          />
          ...
          <input
            ...
            value={consignorConsignee.consignorEmail}
            onInput={(e) => handleConsignorConsignee(e, 'consignorEmail')}
          />
          <label htmlFor="">Consignee Email</label>
          <input
            type="text"
            placeholder="Consignee Email"
            value={consignorConsignee.consigneeEmail}
            onInput={(e) => handleConsignorConsignee(e, 'consigneeEmail')}
          />
        </div>
      </div>
      ...
      <div className={style.formContainer}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="0.00"
            disabled
            value={dimWeight.totalDimWeight}
          />
          ...
          <input
            ...
            placeholder="0.00"
            disabled
            value={dimWeight.totalActualWeight}
          />
          ...
          <input
            ...
            placeholder="0.00"
            disabled
            value={dimWeight.totalChargeWeight}
          />
        </div>
      </div>

      <div className={style.actions}>
        <button className={style.buttonChk} onClick={handleSave}>
          <FaCheck /> Save
        </button>
        <button className={style.buttonRef} onClick={handleReset}>
          <IoRefresh /> Reset
        </button>
      </div>
    </>
