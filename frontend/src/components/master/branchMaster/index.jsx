  ...
  return (
    <tr>
      <td>
        <FaEdit
          style={style}
          onClick={(e) => edit({ ...b, zone: b.zone?._id || '' })}
        />
      </td>
      <td>
        <Popconfirm title="Sure to delete ?" onConfirm={() => deleteBranch(b._id)}>
          <FaTrashAlt
      ...
      <td>
        {b?.isHub
          ? ' '
          : b?.hubBranch?.branchCode + ' : ' + b?.hubBranch?.branchName}
      </td>
...
export default function BranchMaster() {
  ...
  const deleteBranch = async (id) => {
    const res = await useDeleteData('branch?bid=' + id);
    if (res.res) {
      ...
      <div className={style.formContainer}>
        ...
        <div>
          ...
          <input
            ...
            onInput={(e) => handleBranch(e, 'emailId')}
          />
          ...
          <input
            ...
            onInput={(e) => handleBranch(e, 'branchName')}
          />
          ...
          <input
            ...
            placeholder="Place"
            value={branch.place}
            onInput={(e) => handleBranch(e, 'place')}
          />
          ...
          <input
            ...
            onInput={(e) => handleBranch(e, 'contactPerson')}
          />
          ...
          <input
            ...
            onInput={(e) => handleBranch(e, 'pincode')}
          />
          ...
          <input
            ...
            onInput={(e) => handleBranch(e, 'address')}
          />
          ...
          <input
            ...
            value={branch.phone}
            onInput={(e) => handleBranch(e, 'phone')}
          />
          ...
          <input
            ...
            placeholder="Fax No"
            value={branch.faxNo}
            onInput={(e) => handleBranch(e, 'faxNo')}
          />
          ...
          <select value={branch.zone} onInput={(e) => handleBranch(e, 'zone')}>
            ...
            {zones.map((z) => (
              <option value={z._id}>{z.zoneName}</option>
            ))}
          </select>
          ...
          <p>
            <input
              type="checkbox"
              checked={branch?.isHub}
              onChange={(e) => handleBranch(e, 'isHub')}
            />
          </p>
          ...
          <textarea
            ...
            rows="2"
            placeholder="Remarks"
            onInput={(e) => handleBranch(e, 'remarks')}
          ></textarea>
          <span>
          ...
          <span>
            <input
              ...
              disabled={branch?.isHub}
              value={branch._hubBranch}
              onInput={(e) => handleBranch(e, 'hubBranch')}
            />
            ...
            <div>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedBooking?.road}
                  onChange={(e) => handleBranch(e, 'ABR')}
                />{' '}
                Road
              </span>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedBooking?.air}
                  onChange={(e) => handleBranch(e, 'ABA')}
                />{' '}
                Air
              </span>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedBooking?.train}
                  onChange={(e) => handleBranch(e, 'ABT')}
                />{' '}
                Train
              </span>
            </div>
          ...
          <span>
            <div>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedDispatch?.road}
                  onChange={(e) => handleBranch(e, 'ADR')}
                />{' '}
                Road
              </span>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedDispatch?.air}
                  onChange={(e) => handleBranch(e, 'ADA')}
                />{' '}
                Air
              </span>
              <span>
                <input
                  type="checkbox"
                  checked={branch?.allowedDispatch?.train}
                  onChange={(e) => handleBranch(e, 'ADT')}
                />{' '}
                Train
              </span>
            </div>
          ...
          <p>
            <input
              ...
              onChange={(e) => handleBranch(e, 'isActive')}
            />
          </p>
        </div>
      </div>
